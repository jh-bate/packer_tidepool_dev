      ...
      var.os_name == "freebsd" ? [
        ...
        var.os_name == "sles" ? [
          ...
          var.os_name == "debian" ? [
            ...
            "${path.root}/scripts/_common/virtualbox.sh",
            "${path.root}/scripts/_tidepool/1_dependancies.sh",
            "${path.root}/scripts/_tidepool/2_docker.sh",
            "${path.root}/scripts/_tidepool/3_k8s.sh",
            "${path.root}/scripts/_tidepool/4_mongo.sh",
            "${path.root}/scripts/_tidepool/5_tidepool_dev.sh",
